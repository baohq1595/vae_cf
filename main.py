...
log_dir = os.path.join(LOG_DIR, 'log/ml-20m/VAE_anneal{}K_cap{:1.1E}/{}'.format(
...
chkpt_dir = os.path.join(LOG_DIR, 'model/chkpt/ml-20m/VAE_anneal{}K_cap{:1.1E}/{}'.format(
    total_anneal_steps/1000, anneal_cap, arch_str))
...
with tf.Session() as sess:
    vae_writer = tf.summary.FileWriter(os.path.join(LOG_DIR, 'vae/tfb/'), sess._graph)
...
log_dir = os.path.join(LOG_DIR, 'log/ml-20m/DAE/{}'.format(arch_str))
...
chkpt_dir = os.path.join(LOG_DIR, 'chkpt/ml-20m/DAE/{}'.format(arch_str))
